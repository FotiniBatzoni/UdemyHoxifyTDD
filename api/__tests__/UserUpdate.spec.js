...
describe('User Update', () => {
    ...
    `('returns error body $message for unauthorised request when language is $language', async ({ language, message }) => {
      ...
      // fit('saves the user image to upload folder  and stores filename in user when update has image', async () =>{
      //   const fileInBase64 = readFileAsBase64();
  ...
  //   const fileWithExceedingSize2MB = 'a'.repeat(1024 * 1024 * 2) + 'aaaaa'
